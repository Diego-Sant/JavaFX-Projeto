...
public class SellerListController implements Initializable, DataChangeListener {
	...
	// Será responsável por acessar o serviço, carregar os vendedores e jogar no ObservableList
	...
	// Atualizar informações do vendedores
	private void initEditButtons() {
		...
		tableColumnEDIT.setCellFactory(param -> new TableCell<Seller, Seller>() {
			...
			protected void updateItem(Seller obj, boolean empty) {
				...
				// Mesma configuração de criar um vendedores novo, mas por causa do obj ele
				// irá substituir o vendedores existente
				setGraphic(button);
				button.setOnAction(
